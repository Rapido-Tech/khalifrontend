...
export const PrevButton: React.FC<PropType> = (props) => {
  ...
  return (
    <button
      className="embla__button size-10 bg-black text-amber-600 embla__button--prev border border-amber-600 rounded-full"
      type="button"
      {...restProps}
    >
...
export const NextButton: React.FC<PropType> = (props) => {
  ...
  return (
    <button
      className="embla__button embla__button--next size-10  bg-black text-amber-600 embla__button--prev border border-amber-600 rounded-full"
      type="button"
      {...restProps}
    >
      <svg className="embla__button__svg" viewBox="0 0 532 532">
